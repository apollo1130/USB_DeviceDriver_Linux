/*
 * MCP2515 Microship Demo board driver
 *
 * Copyright (C) 2016 Nicolas Delanoue and Remy Guyonneau
 ...
 *
 *
 * The starting point code is mostly from SolidusCode "Linux Kernel Module
 * Programming - USB Device Driver 02"
 *  the video can be found here (12/05/2016)
 * https://www.youtube.com/watch?v=5IDL070RtoQ
 * 
 * Then the rest of the code is partially inspired from the usb_skeleton.c code
 *  http://lxr.free-electrons.com/source/drivers/usb/usb-skeleton.c (12/05/2016)
 * and from the missile launcher driver ml_launcher.c code
 *      https://github.com/mavam/ml-driver/blob/master/ml_driver.c (12/05/2016)
 * Most The comment informations are from (mostly chapter 03 and 13)
 * http://www.oreilly.com/openbook/linuxdrive3/book (12/05/2016)
 *
